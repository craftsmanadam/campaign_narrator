...
PLAYER_INTENT_INSTRUCTIONS: str = (
    ...
    "- npc_dialogue: The player is speaking to or addressing an NPC directly. "
    "Examples: 'I ask the innkeeper', 'What do you know about the bandits?', "
    "'I tell the guard we mean no harm'.\n"
