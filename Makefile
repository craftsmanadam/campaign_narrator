...
.PHONY: bootstrap clean analyze_code format build analyze_image unit_test integration_test watch_unit_tests acceptance_test test verify start stop run_local clear_state stop_local control
